...
managementRouter.get("/", async (req, res) => {
  try {
    ...
    console.log(
      "[Management] DATABASE_URL exists:",
...
farmersRouter.get("/", async (req, res) => {
  try {
...
farmersRouter.get("/:id", async (req, res) => {
  try {
...
farmersRouter.post("/", async (req, res) => {
  try {
    const {
      farmerId,
      farmer_id,
...
farmersRouter.put("/:id", async (req, res) => {
  try {
    const {
      firstName,
      first_name,
...
farmersRouter.delete("/:id", async (req, res) => {
  try {
...
// ===== Ranches Routes =====
const ranchesRouter = Router();

ranchesRouter.get("/", async (req, res) => {
  try {
...
ranchesRouter.get("/:id", async (req, res) => {
  try {
...
ranchesRouter.post("/", async (req, res) => {
  try {
    const {
      name,
      lga,
    ...
    const newRanch = await prisma.ranch.create({
      data: {
        ...
        hasVeterinaryClinic:
          hasVeterinaryClinic ?? has_veterinary_clinic ?? false,
...
ranchesRouter.put("/:id", async (req, res) => {
  try {
    const {
      name,
      lga,
...
ranchesRouter.delete("/:id", async (req, res) => {
  try {
...
statsRouter.get("/ranches", async (req, res) => {
  try {
...
statsRouter.get("/farmers", async (req, res) => {
  try {
...
newsRouter.get("/:idOrSlug", async (req, res) => {
  try {
...
// ===== Grazing Permits Routes =====
const grazingPermitsRouter = Router();

grazingPermitsRouter.get("/stats/summary", async (req, res) => {
  try {
...
grazingPermitsRouter.get("/", async (req, res) => {
  try {
...
grazingPermitsRouter.get("/:idOrReceiptId", async (req, res) => {
  try {
...
grazingPermitsRouter.post("/", async (req, res) => {
  try {
    const {
      receiptId,
      receipt_id,
...
app.use("/api/ranches", ranchesRouter);
app.use("/api/clinics", clinicsRouter);
app.use("/api/stats", statsRouter);
app.use("/api/news", newsRouter);
app.use("/api/reports", reportsRouter);
app.use("/api/grazing-permits", grazingPermitsRouter);
